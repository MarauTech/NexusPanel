...
const API = {
  ...
  widgets: {
    getFavoriteApps: () => api.get('/widgets/favorite-apps'),
    updateFavoriteApps: (service_ids) => api.put('/widgets/favorite-apps', { service_ids }),
    getServerStatus: () => api.get('/widgets/server-status'),
    getServicesSummary: () => api.get('/widgets/services-summary'),
    getUptimeStats: () => api.get('/widgets/uptime-stats'),
    getServiceMonitor: (id) => api.get(id ? `/widgets/service-monitor/${id}` : '/widgets/service-monitor'),
    updateServiceMonitor: (service_id) => api.put('/widgets/service-monitor', { service_id }),
    getOverview: () => api.get('/widgets/overview'),
