...
export default function GlobalStatusStrip({ services = [] }) {
  ...
  return (
    <div 
      className="w-full rounded-lg bg-white dark:bg-[#141b27] border border-slate-300 dark:border-[#1d2635] px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs shadow-xs transition-colors"
      role="region"
    ...
    >
      ...
      <div className="flex items-center gap-4 text-xs font-mono text-slate-600 dark:text-slate-400">
        ...
        <div className="border-l border-slate-300 dark:border-[#1d2635] pl-4">
