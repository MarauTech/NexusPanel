...
export default function GlobalStatusStrip({ services = [] }) {
  ...
  return (
    <div 
      className="w-full rounded-lg bg-[#141b27] border border-[#1d2635] px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs"
      role="region"
    ...
    >
      ...
      <div className="flex items-center gap-4 text-xs font-mono text-slate-400">
        ...
        <div className="border-l border-[#1d2635] pl-4">
          <span className="text-slate-500">uptime: </span>
          <span className="text-emerald-400 font-medium">{overallUptime}% · 24h</span>
        </div>
      </div>
    </div>
  );
