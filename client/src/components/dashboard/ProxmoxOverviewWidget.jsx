    ...
    <div className="rounded-lg bg-white dark:bg-[#141b27] border border-slate-300 dark:border-[#1d2635] p-4 space-y-3 text-xs shadow-xs dark:shadow-none transition-colors">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-[#1c2534]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-slate-600 dark:text-slate-400 font-mono font-semibold">v{nodeData.pveVersion || '8.x'}</span>
        </div>

        <Link
          to="/admin/proxmox"
          className="p-1 text-slate-500 hover:text-slate-800 dark:text-slate-500 dark:hover:text-slate-300 transition-colors"
      ...
      <div className="grid grid-cols-3 gap-2 text-center text-[11px] font-mono">
        <div className="p-2 rounded bg-slate-50 dark:bg-[#18202d] border border-slate-300 dark:border-[#202c3e]">
          <span className="text-slate-700 dark:text-slate-400 text-[10px] block font-bold">CPU</span>
        ...
        <div className="p-2 rounded bg-slate-50 dark:bg-[#18202d] border border-slate-300 dark:border-[#202c3e]">
          <span className="text-slate-700 dark:text-slate-400 text-[10px] block font-bold">RAM</span>
          <span className="font-bold text-slate-900 dark:text-slate-100 text-xs">
        ...
        <div className="p-2 rounded bg-slate-50 dark:bg-[#18202d] border border-slate-300 dark:border-[#202c3e]">
          <span className="text-slate-700 dark:text-slate-400 text-[10px] block font-bold">DYSK</span>
          <span className="font-bold text-slate-900 dark:text-slate-100 text-xs">
      ...
      {totalLxc > 0 && (
        <div className="pt-2 border-t border-slate-200 dark:border-[#1c2534] flex items-center justify-between text-[11px] font-mono text-slate-700 dark:text-slate-400">
          <span className="font-medium">Kontenery LXC:</span>
          <span className="text-slate-900 dark:text-slate-200 font-bold">
            <span className="text-emerald-700 dark:text-emerald-400">{runningLxc}</span>/{totalLxc} aktywne
          </span>
        </div>
      )}
    </div>
