  ...
  return (
    <div className="rounded-lg bg-white dark:bg-[#141b27] border border-slate-200 dark:border-[#1d2635] p-4 space-y-3 text-xs shadow-sm dark:shadow-none transition-colors">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-[#1c2534]">
        ...
        <Link
          to="/admin/proxmox"
          className="p-1 text-slate-400 hover:text-slate-700 dark:text-slate-500 dark:hover:text-slate-300 transition-colors"
      ...
      <div className="grid grid-cols-3 gap-2 text-center text-[11px] font-mono">
        <div className="p-2 rounded bg-slate-50 dark:bg-[#18202d] border border-slate-200 dark:border-[#202c3e]">
      ...
      {totalLxc > 0 && (
        <div className="pt-2 border-t border-slate-100 dark:border-[#1c2534] flex items-center justify-between text-[11px] font-mono text-slate-500 dark:text-slate-400">
          <span>Kontenery LXC:</span>
          <span className="text-slate-800 dark:text-slate-200 font-medium">
            <span className="text-emerald-600 dark:text-emerald-400">{runningLxc}</span>/{totalLxc} aktywne
          </span>
        </div>
      )}
    </div>
