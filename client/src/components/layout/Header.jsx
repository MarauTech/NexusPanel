...
export default function Header() {
  ...
  return (
    <>
      <header className="w-full px-4 sm:px-8 lg:px-12 py-3 border-b border-[#18202d] bg-[#0b0f17] sticky top-0 z-30">
        <div className="w-full flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0 text-xs">
            ...
            <button
              ...
              className="flex items-center gap-2 px-2.5 py-1.5 rounded bg-[#141b27] hover:bg-[#1c2534] text-slate-400 hover:text-slate-200 border border-[#1d2635] transition-colors"
              title={t('header.search', 'Wyszukiwarka (Ctrl+K)')}
            >
              <Search className="w-3.5 h-3.5 text-slate-400" />
              <span className="hidden sm:inline text-slate-300 font-medium">{t('header.spotlight', 'Szukaj')}</span>
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded bg-[#141b27] hover:bg-[#1c2534] text-slate-400 hover:text-slate-200 border border-[#1d2635] font-mono transition-colors"
            ...
            <Link
              to="/kiosk"
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded bg-[#141b27] hover:bg-[#1c2534] text-slate-400 hover:text-slate-200 border border-[#1d2635] transition-colors"
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded bg-[#141b27] hover:bg-[#1c2534] text-slate-400 hover:text-slate-200 border border-[#1d2635] transition-colors"
            ...
            {isAuthenticated ? (
              <button
                onClick={logout}
                className="p-2 rounded bg-[#141b27] hover:bg-rose-900/20 text-slate-400 hover:text-rose-400 border border-[#1d2635] transition-colors"
