  ...
  const content = (
    <div className="flex flex-col space-y-3.5">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          className="w-full bg-white dark:bg-[#18202d] border border-slate-300 dark:border-[#222d41] text-slate-900 dark:text-slate-200 text-xs rounded-md pl-9 pr-3 py-2 focus:outline-none focus:border-blue-500 placeholder:text-slate-400 dark:placeholder:text-slate-500 font-mono shadow-sm dark:shadow-none"
      ...
      {/* Tabs */}
      <div className="flex items-center gap-1.5 border-b border-slate-200 dark:border-[#1c2534] pb-2">
        <button
          type="button"
        ...
        >
          <Grid className="w-3 h-3 text-slate-500 dark:text-slate-400" />
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2.5 p-2 rounded-md text-left transition-colors border cursor-pointer ${
                    isSelected
                      ? 'bg-slate-200 dark:bg-[#1c2534] border-blue-500 ring-1 ring-blue-500'
                      : 'bg-white dark:bg-[#18202d] border-slate-200 dark:border-[#202c3e] hover:border-slate-300 dark:hover:border-[#2f3d56] shadow-sm dark:shadow-none'
                  }`}
                >
                  <div className="w-7 h-7 rounded bg-slate-100 dark:bg-[#141b27] border border-slate-200 dark:border-[#222d41] flex items-center justify-center flex-shrink-0">
                    <BrandIcon name={item.id} className="w-4 h-4" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="font-medium text-xs text-slate-900 dark:text-slate-200 truncate">{item.label}</div>
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-2 rounded-md border transition-colors cursor-pointer ${
                    isSelected
                      ? 'bg-slate-200 dark:bg-[#1c2534] border-blue-500 ring-1 ring-blue-500 text-blue-600 dark:text-blue-400'
                      : 'bg-white dark:bg-[#18202d] border-slate-200 dark:border-[#202c3e] hover:border-slate-300 dark:hover:border-[#2f3d56] text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-200 shadow-sm dark:shadow-none'
                  }`}
                  title={name}
                >
