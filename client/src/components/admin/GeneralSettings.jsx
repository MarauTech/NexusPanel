        ...
        <div className="p-5 rounded-2xl glass-card space-y-4 border border-black/[0.08] dark:border-white/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input
              ...
              helper={t('settings.user_name_helper', 'Wyświetlane w powitaniu na pulpicie: "Witaj, <NAZWA>"')}
            />
            ...
            <Input
              ...
              helper={t('settings.dash_name_helper', 'Wyświetlana w nagłówku i na karcie przeglądarki')}
            />
          </div>
